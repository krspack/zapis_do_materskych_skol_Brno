...
kapacita_jedne_skolky = int(sys.argv[4] if len(sys.argv) > 4 else -1)  # defaultne: skutecne kapacity.
cislo_testu = str(sys.argv[5] if len(sys.argv) > 5 else 1)
...
def get_age(birthday):
    ...
    difference = schoolyear_start - birthday - relativedelta(days = 1)   # prizpusobeni vypoctu webu zapisdoms.brno.cz
